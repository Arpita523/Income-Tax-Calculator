...
const NewRegimeCalculation = () => {
  ...
  if (formDataString) {
    ...
    totalIncome += parseFloat(incomeDetails.otherIncomes.domesticDividend || 0)
    ...
    totalDeductions += parseFloat(deductions.medical.parentsSeniorCitizen || 0)
    ...
    console.log("Gross_Taxable_Income : ", Gross_Taxable_Income)
    console.log("calculatedTax : ", calculatedTax)
    console.log("surcharge : ", surcharge)
    console.log("cess : ", cess)
    console.log("Total_Tax_payable : ", Total_Tax_payable)
  } else {
...
export default NewRegimeCalculation
